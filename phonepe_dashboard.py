...
st.title("Phonepe Project created by Mayur")
...
st.title("This dashboard is for analysis of PhonePe Pulse's data.")
...
st.title('Line Chart with Dropdown Example for Count & Amount')
